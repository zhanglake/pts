...
public class ResponseUtils
{
	 ...
	 * */
	@SuppressWarnings("all")
	public static void renderJsons(HttpServletResponse response, final List list, final String... headers)
	{
	 ...
	 */
	@SuppressWarnings("all")
	public static void renderJsons(HttpServletResponse response,  final Map map, final String... headers)
	{
		String jsonString = JSONObject.fromObject(map).toString();
		renderJson(response, jsonString, headers);
	}
