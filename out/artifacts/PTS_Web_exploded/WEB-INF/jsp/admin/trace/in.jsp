...
<div class="row-fluid">
	<div class="span12 portlet box blue">
		<div class="portlet-title">
			<div class="caption">
				<i class="icon-globe"></i><span class="titleExcel">入库记录</span>
			</div>
		</div>
...
<script type="text/javascript">
	...
	$().ready(function()
	{
		App.loadActions("InQuery", loadActionsBack);
	...
	function doSearch()
	{
		...
		$table = $("#tbList").bootstrapTable("destroy").bootstrapTable({
			 url: "trace/inOutList.do?frmTm=" + frmtm + "&toTm=" + totm + "&actionType=" + actionType + "&searchParam=" + searchParam,
			 pagination: true,
	...
	function doExport()
	{
		...
		$.get("trace/inOutListXls.do", {frmTm: frmtm, toTm: totm, actionType: actionType, searchParam: searchParam}, function(data, status)
		{
			...
			App.handleExport($("#xls-table"), config.title_xls_in_record);
