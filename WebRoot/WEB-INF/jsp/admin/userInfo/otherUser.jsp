...
<div class="row-fluid">
	<div class="span12 portlet box blue">
		<div class="portlet-title">
			<div class="caption">
				<i class="icon-globe"></i><span class="titleExcel">其他操作用户列表</span>
			</div>
		</div>
...
<script type="text/javascript">
	...
	{
		//setRadioButton();
		App.loadActions("CompanyOtherUser", loadActionsBack);
	...
	function doSearch()
	{
		...
		$table = $("#tbList").bootstrapTable("destroy").bootstrapTable({
			 url: "account/userListByType.do?type=" + 2 + "&searchParam=" + $("#searchParam").val(),
			 pagination: true,
	...
	function doExport()
	{
		...
		$.get("account/getByType.do?type=" + 2 + "&searchParam=" + searchParam + "&rlId=", function(data, status)
		{
			$xlsTable.bootstrapTable("load", data);
			
			App.handleExport($("#xls-table"), config.title_xls_CompanyUser_comapny);
