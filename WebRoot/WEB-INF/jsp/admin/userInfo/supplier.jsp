...
<div class="row-fluid">
	<div class="span12 portlet box blue">
		<div class="portlet-title">
			<div class="caption">
				<i class="icon-globe"></i><span class="titleExcel">生产供应商用户列表</span>
			</div>
		</div>
			...
			<table id="xls-table" class="table table-striped table-bordered table-hover table-full-width" style="display: none;">
				<thead>
					<tr>
						...
						<th data-field="supplier_name">所属供应商</th>
...
<script type="text/javascript">
	...
	$().ready(function()
	{
		App.loadActions("SupplierMgr", loadActionsBack);
	...
	function doSearch()
	{
		...
		$table = $("#tbList").bootstrapTable("destroy").bootstrapTable({
			 url: "account/userTpList.do?sysTp=" + 3 + "&searchParam=" + $("#searchParam").val(),
			 pagination: true,
	...
	function doExport()
	{
		...
		$.get("account/getByType.do?type=" + 3 + "&searchParam=" + searchParam + "&rlId=", function(data, status)
		{
			$xlsTable.bootstrapTable("load", data);
			
			App.handleExport($("#xls-table"), config.title_xls_SupplierUser_comapny);
