		...
		<div class="header navbar navbar-inverse navbar-fixed-top">
			...
			<div class="navbar-inner">
				<div class="container-fluid">
					<!-- BEGIN LOGO -->
					<a class="brand" href="#"> <img style="height: 40px;" src="<c:url value="/media/image/logo.png"/>" alt="logo" /> </a>
					<!-- END LOGO -->
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown user">
							<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <span class="username">${C_USR.lgnNm}(平台用户)</span> <i class="icon-angle-down"></i> </a>
							<ul class="dropdown-menu">
								<li>
									<a href="javascript:App.loadPage('account/profilelEdit.do');"><i class="icon-user"></i> 账号信息</a>
								</li>
								<li>
									<a href="index/doLogout.do"><i class="icon-signout"></i> 退出</a>
								</li>
							</ul>
						</li>
