			...
			<div class="modal-body">
				<form action="#" id="fmUserEdit" class="form-horizontal">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="password" placeholder="123" class="form-control" id="pswdOK" name="pswdOK" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">
...
<script type="text/javascript">
	...
	{
		//setRadioButton();
		App.loadActions("UserManeger", loadActionsBack);
	...
	function doSearch()
	{
		...
		$table = $("#tbList").bootstrapTable({
			 url: "account/userList.do?compId=" + compId + "&rlId=" + 2,
			 pagination: true,
