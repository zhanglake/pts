							...
							<div class="row-fluid">
								<div class="span6 ">
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" placeholder="必填项" class="m-wrap span12" id="revenueNO" name="revenueNO" />
										</div>
									</div>
								</div>
								<div class="span6 ">
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" placeholder="必填项" class="m-wrap span12" id="dealer_code" name="dealer_code" />
										</div>
									</div>
								</div>
							</div>
							<div class="row-fluid">
								<div class="span6 ">
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" placeholder="必填项" class="m-wrap span12" id="dealer_name" name="dealer_name" />
										</div>
									</div>
								</div>
								<div class="span6 ">
							...
							<div class="row-fluid">
								...
								<div class="span6 ">
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" placeholder="请输入正确的联系电话" class="m-wrap span12" id="phone" name="phone" />
										</div>
									</div>
								</div>
							...
							<div class="row-fluid">
								...
								<div class="span6">
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" placeholder="请输入正确的区号" class="m-wrap span12" id="areaCode" name="areaCode" />
										</div>
									</div>
								</div>
							</div>
							<div class="row-fluid">
								...
								<div class="span6">
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" id="tel" name="tel" placeholder="请填写正确的电话" class="m-wrap span12" />
										</div>
									</div>
								</div>
							</div>
