...
import com.ptsoft.pts.system.dao.SysActionFunctionMapDao;
import com.ptsoft.pts.system.dao.SysFunctionDao;
import com.ptsoft.pts.system.dao.SysPermissionDao;
...
import com.ptsoft.pts.system.model.vo.SysPermission;
...
public class PermissionService
{
	 ...
	 * 查询指定页面的按钮集合列表
	 * 
	 * @param rlId, @param funcId
	 * @return
	 */
	public List<SysActionFunctionMap> getRoleActionFunctionMap(String rlId, String funcId)
	{
		...
		//加载ActionFunctionMap表
		List<SysActionFunctionMap> afList = this.sysActionFunctionMapDao.getRoleActionFunctionMap(map);
